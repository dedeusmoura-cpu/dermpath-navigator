...
const uiTranslations = {
  pt: {
    ...
    home_quiz: "Quiz",
    home_search: "Buscar",
    home_card_start_body: "Percorra um fluxo histológico guiado até o diagnóstico mais provável.",
    home_card_tree_map_body: "Visualize a árvore diagnóstica e entenda como os padrões se conectam.",
    home_card_quiz_body: "Resolva casos guiados pelo método algorítmico e consolide seu raciocínio diagnóstico.",
    home_card_ted_body: "Treine com questões comentadas no formato TED e fortaleça seu raciocínio diagnóstico.",
    home_diagnostic_title: "Navegação diagnóstica",
    home_explore_title: "Exploração guiada",
    home_quiz_title: "Quiz algorítmico",
    home_ted_title: "Treinamento TED",
    home_path_overview: "Visão geral",
    home_path_exploration: "Exploração",
    home_path_review: "Revisão",
    home_path_training: "Treinamento",
    ...
    home_action_tree: "Abrir árvore",
    home_action_explore: "Começar",
    home_action_quiz: "Resolver casos",
    home_action_ted: "Treinar",
  ...
  en: {
    ...
    home_quiz: "Quiz",
    home_search: "Search",
    home_card_start_body: "Follow a guided histologic flow to the most likely diagnosis.",
    home_card_tree_map_body: "View the diagnostic tree and understand how its patterns connect.",
    home_card_quiz_body: "Solve cases with the algorithmic method and consolidate your diagnostic reasoning.",
    home_card_ted_body: "Practice with commented TED-format questions and strengthen your diagnostic reasoning.",
    home_diagnostic_title: "Diagnostic navigation",
    home_explore_title: "Guided exploration",
    home_quiz_title: "Algorithmic quiz",
    home_ted_title: "TED Training",
    home_path_overview: "Overview",
    home_path_exploration: "Exploration",
    home_path_review: "Review",
    home_path_training: "Training",
    ...
    home_action_tree: "Open tree",
    home_action_explore: "Start",
    home_action_quiz: "Solve cases",
    home_action_ted: "Practice",
