...
export default function App() {
  ...
  const isTreeDiagramPage = location.pathname === "/arvore-interativa";
  ...
  return (
    <div className="app-shell min-h-screen text-ink">
      ...
      {!isTedPage && !isHomePage && !isTreeMapPage && !isTreeDiagramPage && <header className="fixed inset-x-0 top-0 z-30 border-b border-sand/90 bg-white/92 shadow-[0_12px_36px_-30px_rgba(20,27,43,0.45)] backdrop-blur">
      ...
      <main className={`mx-auto max-w-7xl px-4 pb-6 sm:px-6 lg:px-8 ${isTedPage || isHomePage || isTreeMapPage || isTreeDiagramPage ? "pt-4" : "pt-16 sm:pt-24"}`}>
        <Routes>
